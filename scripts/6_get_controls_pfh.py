### Get Controls' Personal/Family Health History ###

# Import
import pandas
import os

# This query represents dataset "Controls_NoOvSurvey_personalfamilyhealthhistory" for domain "survey" and was generated for All of Us Controlled Tier Dataset v8
dataset_57531718_survey_sql = """
    SELECT
        answer.person_id,
...
dataset_57531718_survey_df = pandas.read_gbq(
    dataset_57531718_survey_sql,
    dialect="standard",
    use_bqstorage_api=("BIGQUERY_STORAGE_API_ENABLED" in os.environ),
    progress_bar_type="tqdm_notebook")

unique_questions = dataset_57531718_survey_df["question"].unique()

all_people = (
    dataset_57531718_survey_df[["person_id"]]
        .drop_duplicates()
        .copy()
)
...
who_arthritis = dataset_57531718_survey_df[
    dataset_57531718_survey_df["question"]
        .str.lower()
...
def summarize_cancer_history(cancer_name):
    ...
    cancer_df = dataset_57531718_survey_df[
        dataset_57531718_survey_df["question"]
            .str.lower()
...
who_novcancer = dataset_57531718_survey_df[
    dataset_57531718_survey_df["question"]
        .str.lower()
...
who_novencancer = dataset_57531718_survey_df[
    dataset_57531718_survey_df["question"]
        .str.lower()
...
who_obesity = dataset_57531718_survey_df[
    dataset_57531718_survey_df["question"].str.contains(
